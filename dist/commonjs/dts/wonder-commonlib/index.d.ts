...
declare module 'wonder-commonlib/dist/es2015' {
    export { Collection } from "wonder-commonlib/dist/commonjs/Collection";
    export { $BREAK, $REMOVE } from "wonder-commonlib/dist/commonjs/global/Const";
    export { root } from "wonder-commonlib/dist/commonjs/global/Variable";
    export { Hash } from "wonder-commonlib/dist/commonjs/Hash";
    export { List } from "wonder-commonlib/dist/commonjs/List";
    export { Log } from "wonder-commonlib/dist/commonjs/Log";
    export { Queue } from "wonder-commonlib/dist/commonjs/Queue";
    export { Stack } from "wonder-commonlib/dist/commonjs/Stack";
    export { AjaxUtils } from "wonder-commonlib/dist/commonjs/utils/AjaxUtils";
    export { ArrayUtils } from "wonder-commonlib/dist/commonjs/utils/ArrayUtils";
    export { ConvertUtils } from "wonder-commonlib/dist/commonjs/utils/ConvertUtils";
    export { DomQuery } from "wonder-commonlib/dist/commonjs/utils/DomQuery";
    export { EventUtils } from "wonder-commonlib/dist/commonjs/utils/EventUtils";
    export { ExtendUtils } from "wonder-commonlib/dist/commonjs/utils/ExtendUtils";
    export { FunctionUtils } from "wonder-commonlib/dist/commonjs/utils/FunctionUtils";
    export { JudgeUtils } from "wonder-commonlib/dist/commonjs/utils/JudgeUtils";
    export { PathUtils } from "wonder-commonlib/dist/commonjs/utils/PathUtils";
}

declare module 'wonder-commonlib/dist/commonjs/Collection' {
    import { List } from "wonder-commonlib/dist/commonjs/List";
...
declare module 'wonder-commonlib/dist/commonjs/global/Const' {
    export const $BREAK: {
        break: boolean;
    };
...
declare module 'wonder-commonlib/dist/commonjs/global/Variable' {
    export var root: any;
}

declare module 'wonder-commonlib/dist/commonjs/Hash' {
...
declare module 'wonder-commonlib/dist/commonjs/List' {
    export class List<T> {
...
declare module 'wonder-commonlib/dist/commonjs/Log' {
    export class Log {
        static info: {
...
declare module 'wonder-commonlib/dist/commonjs/Queue' {
    import { List } from "wonder-commonlib/dist/commonjs/List";
...
declare module 'wonder-commonlib/dist/commonjs/Stack' {
    import { List } from "wonder-commonlib/dist/commonjs/List";
    import { Collection } from "wonder-commonlib/dist/commonjs/Collection";
...
declare module 'wonder-commonlib/dist/commonjs/utils/AjaxUtils' {
    export class AjaxUtils {
        static ajax(conf: any): void;
    }
}

declare module 'wonder-commonlib/dist/commonjs/utils/ArrayUtils' {
...
declare module 'wonder-commonlib/dist/commonjs/utils/ConvertUtils' {
    export class ConvertUtils {
        static toString(obj: any): string;
    }
}

declare module 'wonder-commonlib/dist/commonjs/utils/DomQuery' {
...
declare module 'wonder-commonlib/dist/commonjs/utils/EventUtils' {
...
declare module 'wonder-commonlib/dist/commonjs/utils/ExtendUtils' {
...
declare module 'wonder-commonlib/dist/commonjs/utils/FunctionUtils' {
    export class FunctionUtils {
        static bind(object: any, func: Function): () => any;
    }
}

declare module 'wonder-commonlib/dist/commonjs/utils/JudgeUtils' {
...
declare module 'wonder-commonlib/dist/commonjs/utils/PathUtils' {
